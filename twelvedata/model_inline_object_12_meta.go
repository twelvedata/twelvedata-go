...
type InlineObject12Meta struct {
	...
	Indicator InlineObject12MetaIndicator `json:"indicator"`
}

type _InlineObject12Meta InlineObject12Meta
...
func (o *InlineObject12Meta) UnmarshalJSON(data []byte) (err error) {
	...
	varInlineObject12Meta := _InlineObject12Meta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInlineObject12Meta)

	if err != nil {
		return err
	}

	*o = InlineObject12Meta(varInlineObject12Meta)
