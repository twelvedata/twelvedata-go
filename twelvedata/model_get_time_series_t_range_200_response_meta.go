...
type GetTimeSeriesTRange200ResponseMeta struct {
	...
	Indicator GetTimeSeriesTRange200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesTRange200ResponseMeta GetTimeSeriesTRange200ResponseMeta
...
func (o *GetTimeSeriesTRange200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesTRange200ResponseMeta := _GetTimeSeriesTRange200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesTRange200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesTRange200ResponseMeta(varGetTimeSeriesTRange200ResponseMeta)
