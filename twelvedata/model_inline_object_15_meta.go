...
type InlineObject15Meta struct {
	...
	Indicator InlineObject15MetaIndicator `json:"indicator"`
}

type _InlineObject15Meta InlineObject15Meta
...
func (o *InlineObject15Meta) UnmarshalJSON(data []byte) (err error) {
	...
	varInlineObject15Meta := _InlineObject15Meta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varInlineObject15Meta)

	if err != nil {
		return err
	}

	*o = InlineObject15Meta(varInlineObject15Meta)
