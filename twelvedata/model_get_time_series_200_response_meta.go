...
type _GetTimeSeries200ResponseMeta GetTimeSeries200ResponseMeta
...
func NewGetTimeSeries200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string) *GetTimeSeries200ResponseMeta {
...
func (o *GetTimeSeries200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeries200ResponseMeta := _GetTimeSeries200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeries200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeries200ResponseMeta(varGetTimeSeries200ResponseMeta)
