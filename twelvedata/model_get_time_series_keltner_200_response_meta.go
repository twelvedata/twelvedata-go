...
type GetTimeSeriesKeltner200ResponseMeta struct {
	...
	Indicator GetTimeSeriesKeltner200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesKeltner200ResponseMeta GetTimeSeriesKeltner200ResponseMeta
...
func (o *GetTimeSeriesKeltner200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesKeltner200ResponseMeta := _GetTimeSeriesKeltner200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesKeltner200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesKeltner200ResponseMeta(varGetTimeSeriesKeltner200ResponseMeta)
