...
type GetTimeSeriesVar200ResponseMeta struct {
	...
	Indicator GetTimeSeriesVar200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesVar200ResponseMeta GetTimeSeriesVar200ResponseMeta
...
func (o *GetTimeSeriesVar200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesVar200ResponseMeta := _GetTimeSeriesVar200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesVar200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesVar200ResponseMeta(varGetTimeSeriesVar200ResponseMeta)
