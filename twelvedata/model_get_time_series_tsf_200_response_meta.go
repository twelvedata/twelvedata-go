...
type GetTimeSeriesTsf200ResponseMeta struct {
	...
	Indicator GetTimeSeriesTsf200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesTsf200ResponseMeta GetTimeSeriesTsf200ResponseMeta
...
func NewGetTimeSeriesTsf200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string, indicator GetTimeSeriesTsf200ResponseMetaIndicator) *GetTimeSeriesTsf200ResponseMeta {
...
func (o *GetTimeSeriesTsf200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesTsf200ResponseMeta := _GetTimeSeriesTsf200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesTsf200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesTsf200ResponseMeta(varGetTimeSeriesTsf200ResponseMeta)
