...
type GetTimeSeriesSum200ResponseMeta struct {
	...
	Indicator GetTimeSeriesSum200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesSum200ResponseMeta GetTimeSeriesSum200ResponseMeta
...
func (o *GetTimeSeriesSum200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesSum200ResponseMeta := _GetTimeSeriesSum200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesSum200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesSum200ResponseMeta(varGetTimeSeriesSum200ResponseMeta)
