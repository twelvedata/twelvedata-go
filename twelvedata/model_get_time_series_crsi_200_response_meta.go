...
type GetTimeSeriesCrsi200ResponseMeta struct {
	...
	Indicator GetTimeSeriesCrsi200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesCrsi200ResponseMeta GetTimeSeriesCrsi200ResponseMeta
...
func NewGetTimeSeriesCrsi200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string, indicator GetTimeSeriesCrsi200ResponseMetaIndicator) *GetTimeSeriesCrsi200ResponseMeta {
...
func (o *GetTimeSeriesCrsi200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesCrsi200ResponseMeta := _GetTimeSeriesCrsi200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesCrsi200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesCrsi200ResponseMeta(varGetTimeSeriesCrsi200ResponseMeta)
