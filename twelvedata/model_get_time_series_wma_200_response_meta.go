...
type GetTimeSeriesWma200ResponseMeta struct {
	...
	Indicator GetTimeSeriesWma200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesWma200ResponseMeta GetTimeSeriesWma200ResponseMeta
...
func (o *GetTimeSeriesWma200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesWma200ResponseMeta := _GetTimeSeriesWma200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesWma200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesWma200ResponseMeta(varGetTimeSeriesWma200ResponseMeta)
