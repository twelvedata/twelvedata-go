...
type GetTimeSeriesDiv200ResponseMeta struct {
	...
	Indicator GetTimeSeriesDiv200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesDiv200ResponseMeta GetTimeSeriesDiv200ResponseMeta
...
func (o *GetTimeSeriesDiv200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesDiv200ResponseMeta := _GetTimeSeriesDiv200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesDiv200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesDiv200ResponseMeta(varGetTimeSeriesDiv200ResponseMeta)
