...
type GetTimeSeriesAroonOsc200ResponseMeta struct {
	...
	Indicator GetTimeSeriesAroonOsc200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesAroonOsc200ResponseMeta GetTimeSeriesAroonOsc200ResponseMeta
...
func (o *GetTimeSeriesAroonOsc200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesAroonOsc200ResponseMeta := _GetTimeSeriesAroonOsc200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesAroonOsc200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesAroonOsc200ResponseMeta(varGetTimeSeriesAroonOsc200ResponseMeta)
