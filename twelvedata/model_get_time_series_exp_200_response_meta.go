...
type GetTimeSeriesExp200ResponseMeta struct {
	...
	Indicator GetTimeSeriesExp200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesExp200ResponseMeta GetTimeSeriesExp200ResponseMeta
...
func (o *GetTimeSeriesExp200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesExp200ResponseMeta := _GetTimeSeriesExp200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesExp200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesExp200ResponseMeta(varGetTimeSeriesExp200ResponseMeta)
