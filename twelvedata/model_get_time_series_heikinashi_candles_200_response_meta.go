...
type GetTimeSeriesHeikinashiCandles200ResponseMeta struct {
	...
	Indicator GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesHeikinashiCandles200ResponseMeta GetTimeSeriesHeikinashiCandles200ResponseMeta
...
func (o *GetTimeSeriesHeikinashiCandles200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesHeikinashiCandles200ResponseMeta := _GetTimeSeriesHeikinashiCandles200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesHeikinashiCandles200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesHeikinashiCandles200ResponseMeta(varGetTimeSeriesHeikinashiCandles200ResponseMeta)
