...
type GetTimeSeriesMedPrice200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMedPrice200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMedPrice200ResponseMeta GetTimeSeriesMedPrice200ResponseMeta
...
func (o *GetTimeSeriesMedPrice200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMedPrice200ResponseMeta := _GetTimeSeriesMedPrice200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMedPrice200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMedPrice200ResponseMeta(varGetTimeSeriesMedPrice200ResponseMeta)
