...
type GetTimeSeriesTema200ResponseMeta struct {
	...
	Indicator GetTimeSeriesTema200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesTema200ResponseMeta GetTimeSeriesTema200ResponseMeta
...
func (o *GetTimeSeriesTema200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesTema200ResponseMeta := _GetTimeSeriesTema200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesTema200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesTema200ResponseMeta(varGetTimeSeriesTema200ResponseMeta)
