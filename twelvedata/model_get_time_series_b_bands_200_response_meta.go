...
type GetTimeSeriesBBands200ResponseMeta struct {
	...
	Indicator GetTimeSeriesBBands200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesBBands200ResponseMeta GetTimeSeriesBBands200ResponseMeta
...
func (o *GetTimeSeriesBBands200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesBBands200ResponseMeta := _GetTimeSeriesBBands200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesBBands200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesBBands200ResponseMeta(varGetTimeSeriesBBands200ResponseMeta)
