...
type GetTimeSeriesPercentB200ResponseMeta struct {
	...
	Indicator GetTimeSeriesPercentB200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesPercentB200ResponseMeta GetTimeSeriesPercentB200ResponseMeta
...
func (o *GetTimeSeriesPercentB200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesPercentB200ResponseMeta := _GetTimeSeriesPercentB200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesPercentB200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesPercentB200ResponseMeta(varGetTimeSeriesPercentB200ResponseMeta)
