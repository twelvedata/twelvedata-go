...
type GetTimeSeriesTypPrice200ResponseMeta struct {
	...
	Indicator GetTimeSeriesTypPrice200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesTypPrice200ResponseMeta GetTimeSeriesTypPrice200ResponseMeta
...
func (o *GetTimeSeriesTypPrice200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesTypPrice200ResponseMeta := _GetTimeSeriesTypPrice200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesTypPrice200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesTypPrice200ResponseMeta(varGetTimeSeriesTypPrice200ResponseMeta)
