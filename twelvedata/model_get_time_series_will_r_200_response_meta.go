...
type GetTimeSeriesWillR200ResponseMeta struct {
	...
	Indicator GetTimeSeriesWillR200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesWillR200ResponseMeta GetTimeSeriesWillR200ResponseMeta
...
func (o *GetTimeSeriesWillR200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesWillR200ResponseMeta := _GetTimeSeriesWillR200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesWillR200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesWillR200ResponseMeta(varGetTimeSeriesWillR200ResponseMeta)
