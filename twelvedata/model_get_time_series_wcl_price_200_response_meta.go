...
type GetTimeSeriesWclPrice200ResponseMeta struct {
	...
	Indicator GetTimeSeriesWclPrice200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesWclPrice200ResponseMeta GetTimeSeriesWclPrice200ResponseMeta
...
func (o *GetTimeSeriesWclPrice200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesWclPrice200ResponseMeta := _GetTimeSeriesWclPrice200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesWclPrice200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesWclPrice200ResponseMeta(varGetTimeSeriesWclPrice200ResponseMeta)
