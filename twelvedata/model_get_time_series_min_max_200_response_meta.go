...
type GetTimeSeriesMinMax200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMinMax200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMinMax200ResponseMeta GetTimeSeriesMinMax200ResponseMeta
...
func (o *GetTimeSeriesMinMax200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMinMax200ResponseMeta := _GetTimeSeriesMinMax200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMinMax200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMinMax200ResponseMeta(varGetTimeSeriesMinMax200ResponseMeta)
