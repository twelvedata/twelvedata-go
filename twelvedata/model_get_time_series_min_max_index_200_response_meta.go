...
type GetTimeSeriesMinMaxIndex200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMinMaxIndex200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMinMaxIndex200ResponseMeta GetTimeSeriesMinMaxIndex200ResponseMeta
...
func (o *GetTimeSeriesMinMaxIndex200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMinMaxIndex200ResponseMeta := _GetTimeSeriesMinMaxIndex200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMinMaxIndex200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMinMaxIndex200ResponseMeta(varGetTimeSeriesMinMaxIndex200ResponseMeta)
