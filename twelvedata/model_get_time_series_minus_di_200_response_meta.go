...
type GetTimeSeriesMinusDI200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMinusDI200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMinusDI200ResponseMeta GetTimeSeriesMinusDI200ResponseMeta
...
func (o *GetTimeSeriesMinusDI200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMinusDI200ResponseMeta := _GetTimeSeriesMinusDI200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMinusDI200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMinusDI200ResponseMeta(varGetTimeSeriesMinusDI200ResponseMeta)
