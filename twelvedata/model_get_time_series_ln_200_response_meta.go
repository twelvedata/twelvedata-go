...
type GetTimeSeriesLn200ResponseMeta struct {
	...
	Indicator GetTimeSeriesLn200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesLn200ResponseMeta GetTimeSeriesLn200ResponseMeta
...
func (o *GetTimeSeriesLn200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesLn200ResponseMeta := _GetTimeSeriesLn200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesLn200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesLn200ResponseMeta(varGetTimeSeriesLn200ResponseMeta)
