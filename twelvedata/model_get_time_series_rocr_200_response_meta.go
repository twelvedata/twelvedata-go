...
type GetTimeSeriesRocr200ResponseMeta struct {
	...
	Indicator GetTimeSeriesRocr200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesRocr200ResponseMeta GetTimeSeriesRocr200ResponseMeta
...
func NewGetTimeSeriesRocr200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string, indicator GetTimeSeriesRocr200ResponseMetaIndicator) *GetTimeSeriesRocr200ResponseMeta {
...
func (o *GetTimeSeriesRocr200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesRocr200ResponseMeta := _GetTimeSeriesRocr200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesRocr200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesRocr200ResponseMeta(varGetTimeSeriesRocr200ResponseMeta)
