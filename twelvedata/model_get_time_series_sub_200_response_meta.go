...
type GetTimeSeriesSub200ResponseMeta struct {
	...
	Indicator GetTimeSeriesSub200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesSub200ResponseMeta GetTimeSeriesSub200ResponseMeta
...
func NewGetTimeSeriesSub200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string, indicator GetTimeSeriesSub200ResponseMetaIndicator) *GetTimeSeriesSub200ResponseMeta {
...
func (o *GetTimeSeriesSub200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesSub200ResponseMeta := _GetTimeSeriesSub200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesSub200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesSub200ResponseMeta(varGetTimeSeriesSub200ResponseMeta)
