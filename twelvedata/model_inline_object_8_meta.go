...
type InlineObject8Meta struct {
	...
	Indicator InlineObject8MetaIndicator `json:"indicator"`
}

type _InlineObject8Meta InlineObject8Meta
...
func (o *InlineObject8Meta) UnmarshalJSON(data []byte) (err error) {
	...
	*o = InlineObject8Meta(varInlineObject8Meta)
