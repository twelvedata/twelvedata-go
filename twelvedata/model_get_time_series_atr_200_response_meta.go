...
type GetTimeSeriesAtr200ResponseMeta struct {
	...
	Indicator GetTimeSeriesAtr200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesAtr200ResponseMeta GetTimeSeriesAtr200ResponseMeta
...
func NewGetTimeSeriesAtr200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string, indicator GetTimeSeriesAtr200ResponseMetaIndicator) *GetTimeSeriesAtr200ResponseMeta {
...
func (o *GetTimeSeriesAtr200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesAtr200ResponseMeta := _GetTimeSeriesAtr200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesAtr200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesAtr200ResponseMeta(varGetTimeSeriesAtr200ResponseMeta)
