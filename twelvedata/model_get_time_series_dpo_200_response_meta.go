...
type GetTimeSeriesDpo200ResponseMeta struct {
	...
	Indicator GetTimeSeriesDpo200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesDpo200ResponseMeta GetTimeSeriesDpo200ResponseMeta
...
func (o *GetTimeSeriesDpo200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesDpo200ResponseMeta := _GetTimeSeriesDpo200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesDpo200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesDpo200ResponseMeta(varGetTimeSeriesDpo200ResponseMeta)
