...
type GetTimeSeriesAroon200ResponseMeta struct {
	...
	Indicator GetTimeSeriesAroon200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesAroon200ResponseMeta GetTimeSeriesAroon200ResponseMeta
...
func (o *GetTimeSeriesAroon200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesAroon200ResponseMeta := _GetTimeSeriesAroon200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesAroon200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesAroon200ResponseMeta(varGetTimeSeriesAroon200ResponseMeta)
