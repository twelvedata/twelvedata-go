...
type GetTimeSeriesHtTrendline200ResponseMeta struct {
	...
	Indicator GetTimeSeriesHtTrendline200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesHtTrendline200ResponseMeta GetTimeSeriesHtTrendline200ResponseMeta
...
func (o *GetTimeSeriesHtTrendline200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesHtTrendline200ResponseMeta := _GetTimeSeriesHtTrendline200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesHtTrendline200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesHtTrendline200ResponseMeta(varGetTimeSeriesHtTrendline200ResponseMeta)
