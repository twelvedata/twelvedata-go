...
type AdvancedAPIAdvancedRequest struct {
	ctx        context.Context
...
// Map of requests
func (r AdvancedAPIAdvancedRequest) Key(key map[string]AdvancedRequestValue) AdvancedAPIAdvancedRequest {
	r.key = &key
	return r
}

func (r AdvancedAPIAdvancedRequest) Execute() (*Advanced200Response, *http.Response, error) {
...
<li>If one or more requests in the batch contain errors (e.g., invalid symbols or unsupported intervals), it will not affect the successful processing of other requests. Errors are reported individually within the response, allowing you to identify and correct specific issues without impacting the entire batch.</li>
	...
	@return AdvancedAPIAdvancedRequest
*/
func (a *AdvancedAPIService) Advanced(ctx context.Context) AdvancedAPIAdvancedRequest {
	return AdvancedAPIAdvancedRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdvancedAPIService) AdvancedExecute(r AdvancedAPIAdvancedRequest) (*Advanced200Response, *http.Response, error) {
	var (
...
type AdvancedAPIGetApiUsageRequest struct {
	ctx        context.Context
	ApiService *AdvancedAPIService
	format     *FormatEnum
	delimiter  *string
...
// Output format
func (r AdvancedAPIGetApiUsageRequest) Format(format FormatEnum) AdvancedAPIGetApiUsageRequest {
	r.format = &format
	return r
}

// Specify the delimiter used when downloading the CSV file
func (r AdvancedAPIGetApiUsageRequest) Delimiter(delimiter string) AdvancedAPIGetApiUsageRequest {
...
func (r AdvancedAPIGetApiUsageRequest) Timezone(timezone string) AdvancedAPIGetApiUsageRequest {
	r.timezone = &timezone
	return r
}

func (r AdvancedAPIGetApiUsageRequest) Execute() (*GetApiUsage200Response, *http.Response, error) {
...
The API Usage endpoint provides detailed information on your current API usage statistics. It returns data such as the number of requests made, remaining requests, and the reset time for your usage limits. This endpoint is essential for monitoring and managing your API consumption to ensure you stay within your allocated limits.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return AdvancedAPIGetApiUsageRequest
*/
func (a *AdvancedAPIService) GetApiUsage(ctx context.Context) AdvancedAPIGetApiUsageRequest {
	return AdvancedAPIGetApiUsageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdvancedAPIService) GetApiUsageExecute(r AdvancedAPIGetApiUsageRequest) (*GetApiUsage200Response, *http.Response, error) {
	var (
