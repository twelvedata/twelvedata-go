...
type GetTimeSeriesLinearReg200ResponseMeta struct {
	...
	Indicator GetTimeSeriesLinearReg200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesLinearReg200ResponseMeta GetTimeSeriesLinearReg200ResponseMeta
...
func (o *GetTimeSeriesLinearReg200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesLinearReg200ResponseMeta := _GetTimeSeriesLinearReg200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesLinearReg200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesLinearReg200ResponseMeta(varGetTimeSeriesLinearReg200ResponseMeta)
