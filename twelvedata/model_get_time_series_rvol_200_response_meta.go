...
type GetTimeSeriesRvol200ResponseMeta struct {
	...
	Indicator GetTimeSeriesRvol200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesRvol200ResponseMeta GetTimeSeriesRvol200ResponseMeta
...
func (o *GetTimeSeriesRvol200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesRvol200ResponseMeta := _GetTimeSeriesRvol200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesRvol200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesRvol200ResponseMeta(varGetTimeSeriesRvol200ResponseMeta)
