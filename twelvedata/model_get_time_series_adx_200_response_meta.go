...
type GetTimeSeriesAdx200ResponseMeta struct {
	...
	Indicator GetTimeSeriesAdx200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesAdx200ResponseMeta GetTimeSeriesAdx200ResponseMeta
...
func (o *GetTimeSeriesAdx200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesAdx200ResponseMeta := _GetTimeSeriesAdx200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesAdx200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesAdx200ResponseMeta(varGetTimeSeriesAdx200ResponseMeta)
