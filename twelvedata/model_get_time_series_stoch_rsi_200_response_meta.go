...
type GetTimeSeriesStochRsi200ResponseMeta struct {
	...
	Indicator GetTimeSeriesStochRsi200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesStochRsi200ResponseMeta GetTimeSeriesStochRsi200ResponseMeta
...
func NewGetTimeSeriesStochRsi200ResponseMeta(symbol string, interval string, currency string, exchangeTimezone string, exchange string, micCode string, type_ string, indicator GetTimeSeriesStochRsi200ResponseMetaIndicator) *GetTimeSeriesStochRsi200ResponseMeta {
...
func (o *GetTimeSeriesStochRsi200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesStochRsi200ResponseMeta := _GetTimeSeriesStochRsi200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesStochRsi200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesStochRsi200ResponseMeta(varGetTimeSeriesStochRsi200ResponseMeta)
