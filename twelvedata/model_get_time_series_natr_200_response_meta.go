...
type GetTimeSeriesNatr200ResponseMeta struct {
	...
	Indicator GetTimeSeriesNatr200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesNatr200ResponseMeta GetTimeSeriesNatr200ResponseMeta
...
func (o *GetTimeSeriesNatr200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesNatr200ResponseMeta := _GetTimeSeriesNatr200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesNatr200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesNatr200ResponseMeta(varGetTimeSeriesNatr200ResponseMeta)
