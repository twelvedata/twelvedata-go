...
type GetTimeSeriesStoch200ResponseMeta struct {
	...
	Indicator GetTimeSeriesStoch200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesStoch200ResponseMeta GetTimeSeriesStoch200ResponseMeta
...
func (o *GetTimeSeriesStoch200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesStoch200ResponseMeta := _GetTimeSeriesStoch200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesStoch200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesStoch200ResponseMeta(varGetTimeSeriesStoch200ResponseMeta)
