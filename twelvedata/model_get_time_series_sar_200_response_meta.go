...
type GetTimeSeriesSar200ResponseMeta struct {
	...
	Indicator GetTimeSeriesSar200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesSar200ResponseMeta GetTimeSeriesSar200ResponseMeta
...
func (o *GetTimeSeriesSar200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesSar200ResponseMeta := _GetTimeSeriesSar200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesSar200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesSar200ResponseMeta(varGetTimeSeriesSar200ResponseMeta)
