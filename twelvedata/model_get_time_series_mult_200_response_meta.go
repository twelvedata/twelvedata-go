...
type GetTimeSeriesMult200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMult200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMult200ResponseMeta GetTimeSeriesMult200ResponseMeta
...
func (o *GetTimeSeriesMult200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMult200ResponseMeta := _GetTimeSeriesMult200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMult200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMult200ResponseMeta(varGetTimeSeriesMult200ResponseMeta)
