...
type GetTimeSeriesT3ma200ResponseMeta struct {
	...
	Indicator GetTimeSeriesT3ma200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesT3ma200ResponseMeta GetTimeSeriesT3ma200ResponseMeta
...
func (o *GetTimeSeriesT3ma200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesT3ma200ResponseMeta := _GetTimeSeriesT3ma200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesT3ma200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesT3ma200ResponseMeta(varGetTimeSeriesT3ma200ResponseMeta)
