...
type GetTimeSeriesBeta200ResponseMeta struct {
	...
	Indicator GetTimeSeriesBeta200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesBeta200ResponseMeta GetTimeSeriesBeta200ResponseMeta
...
func (o *GetTimeSeriesBeta200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesBeta200ResponseMeta := _GetTimeSeriesBeta200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesBeta200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesBeta200ResponseMeta(varGetTimeSeriesBeta200ResponseMeta)
