...
type GetTimeSeriesLog10200ResponseMeta struct {
	...
	Indicator GetTimeSeriesLog10200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesLog10200ResponseMeta GetTimeSeriesLog10200ResponseMeta
...
func (o *GetTimeSeriesLog10200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesLog10200ResponseMeta := _GetTimeSeriesLog10200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesLog10200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesLog10200ResponseMeta(varGetTimeSeriesLog10200ResponseMeta)
