...
type GetTimeSeriesSma200ResponseMeta struct {
	...
	Indicator GetTimeSeriesSma200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesSma200ResponseMeta GetTimeSeriesSma200ResponseMeta
...
func (o *GetTimeSeriesSma200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesSma200ResponseMeta := _GetTimeSeriesSma200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesSma200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesSma200ResponseMeta(varGetTimeSeriesSma200ResponseMeta)
