...
type GetTimeSeriesLinearRegSlope200ResponseMeta struct {
	...
	Indicator GetTimeSeriesLinearRegSlope200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesLinearRegSlope200ResponseMeta GetTimeSeriesLinearRegSlope200ResponseMeta
...
func (o *GetTimeSeriesLinearRegSlope200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesLinearRegSlope200ResponseMeta := _GetTimeSeriesLinearRegSlope200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesLinearRegSlope200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesLinearRegSlope200ResponseMeta(varGetTimeSeriesLinearRegSlope200ResponseMeta)
