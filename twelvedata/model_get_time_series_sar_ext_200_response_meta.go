...
type GetTimeSeriesSarExt200ResponseMeta struct {
	...
	Indicator GetTimeSeriesSarExt200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesSarExt200ResponseMeta GetTimeSeriesSarExt200ResponseMeta
...
func (o *GetTimeSeriesSarExt200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesSarExt200ResponseMeta := _GetTimeSeriesSarExt200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesSarExt200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesSarExt200ResponseMeta(varGetTimeSeriesSarExt200ResponseMeta)
