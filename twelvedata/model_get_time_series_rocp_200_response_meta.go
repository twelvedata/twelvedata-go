...
type GetTimeSeriesRocp200ResponseMeta struct {
	...
	Indicator GetTimeSeriesRocp200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesRocp200ResponseMeta GetTimeSeriesRocp200ResponseMeta
...
func (o *GetTimeSeriesRocp200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesRocp200ResponseMeta := _GetTimeSeriesRocp200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesRocp200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesRocp200ResponseMeta(varGetTimeSeriesRocp200ResponseMeta)
