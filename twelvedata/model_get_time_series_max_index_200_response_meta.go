...
type GetTimeSeriesMaxIndex200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMaxIndex200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMaxIndex200ResponseMeta GetTimeSeriesMaxIndex200ResponseMeta
...
func (o *GetTimeSeriesMaxIndex200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMaxIndex200ResponseMeta := _GetTimeSeriesMaxIndex200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMaxIndex200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMaxIndex200ResponseMeta(varGetTimeSeriesMaxIndex200ResponseMeta)
