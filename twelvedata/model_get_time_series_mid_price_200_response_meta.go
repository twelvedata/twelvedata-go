...
type GetTimeSeriesMidPrice200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMidPrice200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMidPrice200ResponseMeta GetTimeSeriesMidPrice200ResponseMeta
...
func (o *GetTimeSeriesMidPrice200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GetTimeSeriesMidPrice200ResponseMeta(varGetTimeSeriesMidPrice200ResponseMeta)
