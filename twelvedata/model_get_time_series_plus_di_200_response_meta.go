...
type GetTimeSeriesPlusDI200ResponseMeta struct {
	...
	Indicator GetTimeSeriesPlusDI200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesPlusDI200ResponseMeta GetTimeSeriesPlusDI200ResponseMeta
...
func (o *GetTimeSeriesPlusDI200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesPlusDI200ResponseMeta := _GetTimeSeriesPlusDI200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesPlusDI200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesPlusDI200ResponseMeta(varGetTimeSeriesPlusDI200ResponseMeta)
