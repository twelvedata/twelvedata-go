...
type GetTimeSeriesBop200ResponseMeta struct {
	...
	Indicator GetTimeSeriesBop200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesBop200ResponseMeta GetTimeSeriesBop200ResponseMeta
...
func (o *GetTimeSeriesBop200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesBop200ResponseMeta := _GetTimeSeriesBop200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesBop200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesBop200ResponseMeta(varGetTimeSeriesBop200ResponseMeta)
