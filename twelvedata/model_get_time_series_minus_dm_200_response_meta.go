...
type GetTimeSeriesMinusDM200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMinusDM200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMinusDM200ResponseMeta GetTimeSeriesMinusDM200ResponseMeta
...
func (o *GetTimeSeriesMinusDM200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMinusDM200ResponseMeta := _GetTimeSeriesMinusDM200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesMinusDM200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMinusDM200ResponseMeta(varGetTimeSeriesMinusDM200ResponseMeta)
