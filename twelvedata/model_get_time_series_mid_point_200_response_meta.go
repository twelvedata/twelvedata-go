...
type GetTimeSeriesMidPoint200ResponseMeta struct {
	...
	Indicator GetTimeSeriesMidPoint200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesMidPoint200ResponseMeta GetTimeSeriesMidPoint200ResponseMeta
...
func (o *GetTimeSeriesMidPoint200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesMidPoint200ResponseMeta := _GetTimeSeriesMidPoint200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetTimeSeriesMidPoint200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesMidPoint200ResponseMeta(varGetTimeSeriesMidPoint200ResponseMeta)
