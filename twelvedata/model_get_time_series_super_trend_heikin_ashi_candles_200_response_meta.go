...
type GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta struct {
	...
	Indicator GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMetaIndicator `json:"indicator"`
}

type _GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta
...
func (o *GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta) UnmarshalJSON(data []byte) (err error) {
	...
	varGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta := _GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	err = decoder.Decode(&varGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta)

	if err != nil {
		return err
	}

	*o = GetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta(varGetTimeSeriesSuperTrendHeikinAshiCandles200ResponseMeta)
