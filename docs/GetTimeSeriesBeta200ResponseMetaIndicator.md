...
**SeriesType1** | **string** | Price type used as the first part of technical indicator | 
**SeriesType2** | **string** | Price type used as the second part of technical indicator | 
**TimePeriod** | **int64** | Number of periods to average over | 

## Methods

### NewGetTimeSeriesBeta200ResponseMetaIndicator
...
### NewGetTimeSeriesBeta200ResponseMetaIndicatorWithDefaults
