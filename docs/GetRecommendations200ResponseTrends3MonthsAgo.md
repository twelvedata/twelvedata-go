...
------------ | ------------- | ------------- | -------------
**StrongBuy** | Pointer to **int64** | Number of analysts that give a strong buy recommendation | [optional] 
**Buy** | Pointer to **int64** | Number of analysts that give a buy recommendation | [optional] 
**Hold** | Pointer to **int64** | Number of analysts that give a hold recommendation | [optional] 
**Sell** | Pointer to **int64** | Number of analysts that give a sell recommendation | [optional] 
**StrongSell** | Pointer to **int64** | Number of analysts that give a strong sell recommendation | [optional] 

## Methods

### NewGetRecommendations200ResponseTrends3MonthsAgo
...
### NewGetRecommendations200ResponseTrends3MonthsAgoWithDefaults
